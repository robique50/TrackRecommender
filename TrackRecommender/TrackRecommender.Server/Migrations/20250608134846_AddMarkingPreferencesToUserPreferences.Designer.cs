...
namespace TrackRecommender.Server.Migrations
{
    ...
    [Migration("20250608134846_AddMarkingPreferencesToUserPreferences")]
    partial class AddMarkingPreferencesToUserPreferences
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrackRecommender.Server.Models.UserPreferences", b =>
                {
                    ...
                    b.Property<string>("MarkingPreferences")
                        .HasColumnType("nvarchar(max)");
